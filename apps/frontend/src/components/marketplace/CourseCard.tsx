  ...
  return (
    <div className="group bg-white/90 dark:bg-stone-900/90 backdrop-blur-sm rounded-2xl border border-white/50 dark:border-stone-800/50 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden hover:-translate-y-1">
      ...
      <div className="p-6 space-y-4">
        ...
        {/* Title */}
        <h3 className="text-lg font-bold text-stone-900 dark:text-stone-100 line-clamp-2 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
          {course.title}
        </h3>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-stone-200 dark:border-stone-700">
          ...
          <div className="flex flex-col space-y-2">
            <button className="bg-gradient-to-r from-amber-400 to-orange-500 text-white font-semibold py-2 px-4 rounded-xl hover:from-amber-500 hover:to-orange-600 transition-all duration-200 flex items-center space-x-2">
